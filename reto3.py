...
def AutoPartes(ventas: list):
    ventasTemp={} #se requiere inicializar un diccionario vacio
    for IdProducto, dProducto, pnProducto, cvProducto, sProducto, nComprador, cComprador, fVenta in ventas:
        if ventasTemp.get(IdProducto) is None: # comprueba IdProducto existente 
            ventasTemp[IdProducto]=[] # valor agregado si IdProducto no aparece en registro
        # agregando nueva entrada al diccionario
